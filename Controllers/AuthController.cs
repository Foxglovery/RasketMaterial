...
using System.Text;
using RasketMaterial.Models;
using RasketMaterial.Models.DTOs;
using RasketMaterial.Data;

namespace RasketMaterial.Controllers;
...
{
    private RasketMaterialDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(RasketMaterialDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
