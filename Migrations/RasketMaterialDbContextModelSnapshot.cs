...
{
    [DbContext(typeof(RasketMaterialDbContext))]
    partial class RasketMaterialDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c8937bed-2993-4f52-9dd8-d9de6bcac5ce",
                            Email = "admin@neopets.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEHKuSvgb0is7y4unPhzDBGgYoqG3PyfslyAQil5XNGOLz2mCbRHMEL3wR918eEH3yw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a88146a0-8942-4cfa-9785-291358567030",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f43372bb-aae1-474e-a4ce-f4fbe98fb131",
                            Email = "Schlebethany@neopets.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEJWiKAFz1css7UnTMK3pQUH83Kulr6glGCzWCuQh0vctb1dynMZlYylnASro/Z3MGg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "37d78f53-f4ba-4d2f-9d14-a091fa639b69",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("RasketMaterial.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.EventService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.Venue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.VenueService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RasketMaterial.Models.Event", b =>
                {
                    b.HasOne("RasketMaterial.Models.UserProfile", "UserProfile")
                        .WithMany("Events")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RasketMaterial.Models.Venue", "Venue")
                        .WithMany()
            ...
            modelBuilder.Entity("RasketMaterial.Models.EventService", b =>
                {
                    b.HasOne("RasketMaterial.Models.Event", null)
                        .WithMany("EventServices")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RasketMaterial.Models.Service", "Service")
                        .WithMany()
