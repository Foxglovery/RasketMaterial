...
namespace RasketMaterial.Data;
public class RasketMaterialDbContext : IdentityDbContext<IdentityUser>
{
    ...
    public RasketMaterialDbContext(DbContextOptions<RasketMaterialDbContext> context, IConfiguration config) : base(context)
    {
